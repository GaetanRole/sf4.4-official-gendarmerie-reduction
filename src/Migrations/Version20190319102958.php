 ...
 */
final class Version20190319102958 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE opinion (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, reduction_id INT NOT NULL, name VARCHAR(64) DEFAULT NULL, email VARCHAR(64) DEFAULT NULL, client_ip VARCHAR(16) DEFAULT NULL, comment LONGTEXT NOT NULL, creation_date DATETIME NOT NULL, INDEX IDX_AB02B027A76ED395 (user_id), INDEX IDX_AB02B027C03CB092 (reduction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reduction (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, brand_id INT NOT NULL, name VARCHAR(64) DEFAULT NULL, email VARCHAR(64) DEFAULT NULL, client_ip VARCHAR(16) DEFAULT NULL, title VARCHAR(64) NOT NULL, slug VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, region VARCHAR(32) NOT NULL, department VARCHAR(32) NOT NULL, city VARCHAR(64) NOT NULL, creation_date DATETIME NOT NULL, is_big_deal TINYINT(1) NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_B1E754682B36786B (title), UNIQUE INDEX UNIQ_B1E75468989D9B62 (slug), INDEX IDX_B1E75468A76ED395 (user_id), INDEX IDX_B1E7546844F5D008 (brand_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(64) NOT NULL, identity VARCHAR(64) NOT NULL, email VARCHAR(64) DEFAULT NULL, phone_number VARCHAR(32) DEFAULT NULL, password VARCHAR(255) NOT NULL, creation_date DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, roles JSON NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
