 ...
 */
final class Version20190523051932 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reduction (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, brand_id INT NOT NULL, title VARCHAR(64) NOT NULL, slug VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, region VARCHAR(2) NOT NULL, department VARCHAR(3) DEFAULT NULL, municipality VARCHAR(64) DEFAULT NULL, creation_date DATETIME NOT NULL, is_big_deal TINYINT(1) NOT NULL, is_active TINYINT(1) NOT NULL, name VARCHAR(64) DEFAULT NULL, email VARCHAR(64) DEFAULT NULL, client_ip VARCHAR(16) DEFAULT NULL, UNIQUE INDEX UNIQ_B1E754682B36786B (title), UNIQUE INDEX UNIQ_B1E75468989D9B62 (slug), INDEX IDX_B1E75468A76ED395 (user_id), INDEX IDX_B1E7546844F5D008 (brand_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
