 ...
 */
final class Version20200513112450 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reduction (id INT UNSIGNED AUTO_INCREMENT NOT NULL, user_id INT UNSIGNED NOT NULL, brand_id INT UNSIGNED NOT NULL, image_id INT UNSIGNED DEFAULT NULL, title VARCHAR(64) NOT NULL, slug VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, region VARCHAR(13) NOT NULL, department VARCHAR(3) DEFAULT NULL, municipality VARCHAR(64) DEFAULT NULL, is_big_deal TINYINT(1) NOT NULL, is_active TINYINT(1) NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL, name VARCHAR(64) DEFAULT NULL, email VARCHAR(64) DEFAULT NULL, client_ip VARCHAR(16) DEFAULT NULL, UNIQUE INDEX UNIQ_B1E754682B36786B (title), UNIQUE INDEX UNIQ_B1E75468989D9B62 (slug), UNIQUE INDEX UNIQ_B1E75468D17F50A6 (uuid), INDEX IDX_B1E75468A76ED395 (user_id), INDEX IDX_B1E7546844F5D008 (brand_id), UNIQUE INDEX UNIQ_B1E754683DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT UNSIGNED AUTO_INCREMENT NOT NULL, username VARCHAR(64) NOT NULL, identity VARCHAR(64) NOT NULL, email VARCHAR(64) DEFAULT NULL, phone_number VARCHAR(32) DEFAULT NULL, avatar VARCHAR(25) NOT NULL, password VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, roles JSON NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649D17F50A6 (uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE article (id INT UNSIGNED AUTO_INCREMENT NOT NULL, user_id INT UNSIGNED NOT NULL, title VARCHAR(64) NOT NULL, slug VARCHAR(100) NOT NULL, summary VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, resources LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', priority SMALLINT NOT NULL, is_active TINYINT(1) NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_23A0E662B36786B (title), UNIQUE INDEX UNIQ_23A0E66989D9B62 (slug), UNIQUE INDEX UNIQ_23A0E66D17F50A6 (uuid), INDEX IDX_23A0E66A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
